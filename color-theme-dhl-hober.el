...
;;;;;
;;;;; His providing of such a nice base for further personalization
...
;; Copyright (C) 1997 -- 2008 Edward O'Connor <ted@oconnor.cx>
;; Copyright (C) 2009 Daniel H. Leidisch
...
speedbar, tex, view, viper, w3m, widget, woman"
  ...
  (color-theme-install
   `(color-theme-dhl-hober
     ...
     (lazy-highlight ((t (:foreground "indian red"))))
     ...
     (js2-comment-face ((t (:foreground "indian red"))))
     (js2-constant-face ((t (:foreground "pale violet red"))))
     (js2-error-face ((t (:foreground "indian red"))))
     ...
     (js2-warning-face ((t (:foreground "indian red"))))
     ...
     (svn-status-directory-face ((t (:foreground "cornflower blue"))))
     ...
     (slime-error-face ((t (:foreground "indian red"))))
     (slime-warning-face ((t (:foreground "indian red"))))
     (slime-style-warning-face ((t (:foreground "indian red"))))
     (slime-note-face ((t (:foreground "indian red"))))
     (slime-highlight-face ((t (:foreground "indian red"))))
     ...
     (woman-bold ((t (:foreground "IndianRed1"))))
     (woman-unknwon ((t (:foreground "cadet blue")))) ;%
     (woman-addition ((t (:foreground "medium sea green"))))
